...
export const LEGAL_COMPLIANCE_TEMPLATES = [
  {
    ...
    content: {
      ops: [
        ...
        { insert: '- Access your personal data\n- Request correction or deletion\n- Object to processing\n- Data portability\n- Withdraw consent\n\n' },
        { insert: '6. SECURITY\n', attributes: { bold: true } },
        ...
        { insert: 'Our services are not intended for children under {{minimum_age}} years of age.\n\n' },
        { insert: '9. CHANGES TO THIS POLICY\n', attributes: { bold: true } },
        { insert: 'We may update this policy periodically. Changes will be posted on this page.\n\n' },
        { insert: '10. CONTACT US\n', attributes: { bold: true } },
        { insert: 'For questions about this Privacy Policy, contact us at:\n{{contact_email}}\n{{contact_address}}\n' },
      ],
    },
    placeholders: [
  ...
  },
  {
    ...
    content: {
      ops: [
        ...
        { insert: 'Welcome to {{company_name}}. By accessing or using our services, you agree to these Terms of Service.\n\n' },
        { insert: '1. ACCEPTANCE OF TERMS\n', attributes: { bold: true } },
        { insert: 'By using our services, you agree to be bound by these Terms. If you do not agree, do not use our services.\n\n' },
        { insert: '2. SERVICE DESCRIPTION\n', attributes: { bold: true } },
        { insert: '{{service_description}}\n\n' },
        { insert: '3. USER ACCOUNTS\n', attributes: { bold: true } },
        { insert: '- You must be {{minimum_age}} years or older to use our services\n- You are responsible for maintaining account security\n- You must provide accurate registration information\n\n' },
        { insert: '4. ACCEPTABLE USE\n', attributes: { bold: true } },
        { insert: 'You agree NOT to:\n' },
        { insert: '- Violate any laws or regulations\n- Infringe intellectual property rights\n- Transmit harmful or malicious content\n- Attempt to gain unauthorized access\n- Interfere with service operations\n\n' },
        { insert: '5. PAYMENT TERMS\n', attributes: { bold: true } },
        { insert: '{{payment_terms}}\n\n' },
        { insert: '6. INTELLECTUAL PROPERTY\n', attributes: { bold: true } },
        { insert: 'All content and materials are owned by {{company_name}} and protected by intellectual property laws.\n\n' },
        { insert: '7. TERMINATION\n', attributes: { bold: true } },
        { insert: 'We may terminate or suspend your access at our discretion for violation of these Terms.\n\n' },
  ...
  },
  {
    ...
    content: {
      ops: [
        ...
        { insert: 'Terms used herein have the meanings set forth in the GDPR (Regulation (EU) 2016/679).\n\n' },
        { insert: '2. SUBJECT MATTER AND DURATION\n', attributes: { bold: true } },
        { insert: 'Nature of Processing: {{processing_nature}}\nPurpose: {{processing_purpose}}\nDuration: {{processing_duration}}\n\n' },
        ...
        { insert: '- Process data only on documented instructions\n- Ensure personnel confidentiality\n- Implement appropriate security measures\n- Assist with data subject requests\n- Maintain processing records\n- Cooperate with supervisory authorities\n\n' },
        ...
        { insert: 'Processor shall notify Controller within {{breach_notification_hours}} hours of becoming aware of a breach.\n\n' },
        { insert: '9. AUDIT RIGHTS\n', attributes: { bold: true } },
        { insert: 'Controller may audit Processor compliance with {{audit_notice}} days prior notice.\n\n' },
        { insert: 'SIGNATURES:\n\n', attributes: { bold: true } },
    ...
    placeholders: [
      ...
      { key: 'processing_purpose', type: 'textarea', label: 'Purpose of Processing', required: true },
      { key: 'processing_duration', type: 'text', label: 'Processing Duration', required: true },
      { key: 'data_subject_categories', type: 'textarea', label: 'Categories of Data Subjects', required: true },
      { key: 'personal_data_types', type: 'textarea', label: 'Types of Personal Data', required: true },
      { key: 'subprocessors', type: 'textarea', label: 'Approved Sub-processors', required: false },
      { key: 'breach_notification_hours', type: 'number', label: 'Breach Notification (Hours)', required: true },
      { key: 'audit_notice', type: 'number', label: 'Audit Notice (Days)', required: true },
    ],
    signatureFields: [
      { id: 'controller_signature', label: 'Controller Signature', required: true, position: { page: 1, x: 100, y: 700 } },
      { id: 'processor_signature', label: 'Processor Signature', required: true, position: { page: 1, x: 100, y: 740 } },
    ],
    settings: { paperSize: 'A4', orientation: 'portrait', margins: { top: 1, right: 1, bottom: 1, left: 1 } },
  },
  {
    ...
    content: {
      ops: [
        ...
        { insert: '\nLast Updated: ', attributes: { bold: true } },
        { insert: '{{last_updated}}\n\n' },
        { insert: 'This Cookie Policy explains how {{company_name}} uses cookies and similar technologies.\n\n' },
        { insert: '1. WHAT ARE COOKIES?\n', attributes: { bold: true } },
        { insert: 'Cookies are small text files stored on your device when you visit our website.\n\n' },
        ...
        { insert: 'Session Cookies: Deleted when you close your browser\nPersistent Cookies: Remain for {{cookie_duration}}\n\n' },
        { insert: '5. MANAGING COOKIES\n', attributes: { bold: true } },
        { insert: 'You can manage cookies through your browser settings or our cookie consent tool.\n\n' },
        { insert: '6. CONTACT US\n', attributes: { bold: true } },
    ...
    placeholders: [
      { key: 'last_updated', type: 'date', label: 'Last Updated Date', required: true },
      { key: 'company_name', type: 'text', label: 'Company Name', required: true },
      { key: 'third_party_cookies', type: 'textarea', label: 'Third-Party Cookie Providers', required: false },
  ...
  },
  {
    ...
    content: {
      ops: [
        ...
        { insert: '- Not use or disclose PHI except as permitted\n- Use appropriate safeguards\n- Report any unauthorized use or disclosure\n- Ensure subcontractors agree to same restrictions\n- Make PHI available to individuals\n- Make records available to HHS\n- Return or destroy PHI upon termination\n\n' },
        { insert: '4. SECURITY REQUIREMENTS\n', attributes: { bold: true } },
        { insert: 'Business Associate shall implement administrative, physical, and technical safeguards as required by the Security Rule.\n\n' },
        { insert: '5. BREACH NOTIFICATION\n', attributes: { bold: true } },
        { insert: 'Business Associate shall notify Covered Entity of any breach within {{breach_notification_days}} days.\n\n' },
        ...
        { insert: 'This Agreement shall be governed by federal law and the laws of {{governing_state}}.\n\n' },
        { insert: 'SIGNATURES:\n\n', attributes: { bold: true } },
    ...
    placeholders: [
      ...
      { key: 'covered_entity_address', type: 'text', label: 'Covered Entity Address', required: true },
      { key: 'business_associate_name', type: 'text', label: 'Business Associate Name', required: true },
      { key: 'business_associate_address', type: 'text', label: 'Business Associate Address', required: true },
      { key: 'permitted_uses', type: 'textarea', label: 'Permitted Uses of PHI', required: true },
      { key: 'breach_notification_days', type: 'number', label: 'Breach Notification (Days)', required: true },
      { key: 'governing_state', type: 'text', label: 'Governing State', required: true },
    ],
    signatureFields: [
      { id: 'covered_entity_signature', label: 'Covered Entity Signature', required: true, position: { page: 1, x: 100, y: 700 } },
      { id: 'business_associate_signature', label: 'Business Associate Signature', required: true, position: { page: 1, x: 100, y: 740 } },
    ],
    settings: { paperSize: 'A4', orientation: 'portrait', margins: { top: 1, right: 1, bottom: 1, left: 1 } },
  },
  {
    ...
    content: {
      ops: [
        ...
        { insert: '\nEffective Date: ', attributes: { bold: true } },
        { insert: '{{effective_date}}\n\n' },
        { insert: 'This Acceptable Use Policy ("AUP") governs the use of {{company_name}} services and systems.\n\n' },
        { insert: '1. PURPOSE\n', attributes: { bold: true } },
        { insert: 'This policy outlines acceptable and unacceptable uses of our services to ensure security and compliance.\n\n' },
  ...
  },
  {
    ...
    content: {
      ops: [
        ...
        { insert: '{{valid_until}}\n\n' },
        { insert: 'This certification confirms that the organization has demonstrated compliance with all applicable requirements of the standard through documented evidence and assessment procedures.\n\n' },
    ...
    placeholders: [
      ...
      { key: 'certification_scope', type: 'textarea', label: 'Certification Scope', required: true },
    ...
    signatureFields: [
      { id: 'certifier_signature', label: 'Certifier Signature', required: true, position: { page: 1, x: 100, y: 680 } },
    ],
    settings: { paperSize: 'A4', orientation: 'portrait', margins: { top: 1, right: 1, bottom: 1, left: 1 } },
  },
  {
    ...
    placeholders: [
      ...
      { key: 'regulations_covered', type: 'textarea', label: 'Regulations Covered', required: true },
      { key: 'overall_status', type: 'select', label: 'Overall Status', required: true, options: ['Compliant', 'Partially Compliant', 'Non-Compliant'] },
      { key: 'key_findings', type: 'textarea', label: 'Key Findings', required: true },
      { key: 'non_compliance_areas', type: 'textarea', label: 'Non-Compliance Areas', required: false },
      { key: 'remediation_actions', type: 'textarea', label: 'Remediation Actions', required: false },
    ...
    signatureFields: [
      { id: 'approver_signature', label: 'Approver Signature', required: true, position: { page: 1, x: 100, y: 700 } },
    ],
    settings: { paperSize: 'A4', orientation: 'portrait', margins: { top: 1, right: 1, bottom: 1, left: 1 } },
  },
];
