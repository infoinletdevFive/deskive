...
export const LEGAL_IP_TEMPLATES = [
  {
    ...
    content: {
      ops: [
        ...
        { insert: 'Assignor hereby assigns to Assignee all right, title, and interest in and to the following trademark(s):\n' },
        { insert: 'Mark: {{trademark_name}}\nRegistration Number: {{registration_number}}\nRegistration Date: {{registration_date}}\nGoods/Services: {{goods_services}}\n\n' },
        { insert: '2. GOODWILL\n', attributes: { bold: true } },
        { insert: 'This assignment includes the goodwill of the business associated with the trademark(s).\n\n' },
        { insert: '3. CONSIDERATION\n', attributes: { bold: true } },
        { insert: 'In consideration for this assignment, Assignee shall pay Assignor: {{consideration}}\n\n' },
        { insert: '4. REPRESENTATIONS AND WARRANTIES\n', attributes: { bold: true } },
        { insert: 'Assignor represents and warrants that:\n' },
        { insert: '- Assignor is the sole owner of the trademark(s)\n- The trademark(s) are valid and subsisting\n- There are no liens or encumbrances\n- No litigation is pending regarding the trademark(s)\n\n' },
        { insert: '5. FURTHER ASSURANCES\n', attributes: { bold: true } },
        { insert: 'Assignor agrees to execute any additional documents necessary to perfect the assignment.\n\n' },
    ...
    signatureFields: [
      { id: 'assignor_signature', label: 'Assignor Signature', required: true, position: { page: 1, x: 100, y: 700 } },
      { id: 'assignee_signature', label: 'Assignee Signature', required: true, position: { page: 1, x: 100, y: 740 } },
    ],
  ...
  },
  {
    ...
    content: {
      ops: [
        ...
        { insert: 'The parties agree that the Work shall be considered a "work made for hire" as defined under the Copyright Act. All rights in the Work shall belong to the Commissioning Party from the moment of creation.\n\n' },
        { insert: '3. ASSIGNMENT OF RIGHTS\n', attributes: { bold: true } },
        { insert: 'To the extent the Work does not qualify as work for hire, Creator hereby assigns all rights to the Commissioning Party.\n\n' },
        { insert: '4. DELIVERABLES\n', attributes: { bold: true } },
        { insert: '{{deliverables}}\n\n' },
        { insert: '5. DEADLINE\n', attributes: { bold: true } },
        { insert: 'The Work shall be delivered by: {{delivery_date}}\n\n' },
        { insert: '6. COMPENSATION\n', attributes: { bold: true } },
        { insert: 'Commissioning Party shall pay Creator: {{compensation}}\nPayment Schedule: {{payment_schedule}}\n\n' },
        ...
        { insert: 'Creator represents that the Work will be original and will not infringe any third party rights.\n\n' },
        { insert: '9. CONFIDENTIALITY\n', attributes: { bold: true } },
        { insert: 'Creator agrees to maintain confidentiality of all project-related information.\n\n' },
        { insert: 'IN WITNESS WHEREOF:\n\n', attributes: { bold: true } },
    ...
    placeholders: [
      { key: 'effective_date', type: 'date', label: 'Effective Date', required: true },
      { key: 'commissioning_party_name', type: 'text', label: 'Commissioning Party Name', required: true },
      { key: 'commissioning_party_address', type: 'text', label: 'Commissioning Party Address', required: true },
    ...
    signatureFields: [
      { id: 'commissioning_party_signature', label: 'Commissioning Party Signature', required: true, position: { page: 1, x: 100, y: 700 } },
      { id: 'creator_signature', label: 'Creator Signature', required: true, position: { page: 1, x: 100, y: 740 } },
    ],
    settings: { paperSize: 'A4', orientation: 'portrait', margins: { top: 1, right: 1, bottom: 1, left: 1 } },
  },
  {
    ...
    content: {
      ops: [
        ...
        { insert: '1. SOFTWARE\n', attributes: { bold: true } },
        { insert: 'Software Name: {{software_name}}\nVersion: {{software_version}}\nDescription: {{software_description}}\n\n' },
    ...
    placeholders: [
      ...
      { key: 'software_description', type: 'textarea', label: 'Software Description', required: true },
      { key: 'license_type', type: 'select', label: 'License Type', required: true, options: ['Perpetual', 'Subscription', 'Trial', 'Enterprise'] },
      { key: 'number_of_users', type: 'number', label: 'Number of Users', required: true },
      { key: 'number_of_installations', type: 'number', label: 'Number of Installations', required: true },
  ...
  },
  {
    ...
    placeholders: [
      ...
      { key: 'invention_description', type: 'textarea', label: 'Invention Description', required: true },
      { key: 'problem_solved', type: 'textarea', label: 'Problem Solved', required: true },
      { key: 'novelty_description', type: 'textarea', label: 'Novelty Description', required: true },
      { key: 'prior_art', type: 'textarea', label: 'Prior Art', required: false },
      { key: 'development_status', type: 'select', label: 'Development Status', required: true, options: ['Concept', 'Prototype', 'Working Model', 'Production Ready'] },
      { key: 'conception_date', type: 'date', label: 'Conception Date', required: true },
      { key: 'reduction_to_practice', type: 'date', label: 'First Reduction to Practice', required: false },
      { key: 'public_disclosure', type: 'select', label: 'Public Disclosure', required: true, options: ['Yes', 'No'] },
      { key: 'disclosure_details', type: 'textarea', label: 'Disclosure Details', required: false },
      { key: 'commercial_potential', type: 'textarea', label: 'Commercial Potential', required: true },
      { key: 'funding_sources', type: 'textarea', label: 'Funding Sources', required: false },
      { key: 'supporting_materials', type: 'textarea', label: 'Supporting Materials', required: false },
    ],
    signatureFields: [
      { id: 'inventor_signature', label: 'Inventor Signature', required: true, position: { page: 1, x: 100, y: 720 } },
    ],
    settings: { paperSize: 'A4', orientation: 'portrait', margins: { top: 1, right: 1, bottom: 1, left: 1 } },
  },
  {
    ...
    content: {
      ops: [
        ...
        { insert: '1. PURPOSE\n', attributes: { bold: true } },
        { insert: 'This policy establishes guidelines for the creation, ownership, and protection of intellectual property ("IP") created by or for {{company_name}}.\n\n' },
        { insert: '2. SCOPE\n', attributes: { bold: true } },
        { insert: 'This policy applies to all employees, contractors, consultants, and others who create IP in connection with their work for the Company.\n\n' },
        { insert: '3. DEFINITIONS\n', attributes: { bold: true } },
        { insert: '- Patents: Inventions and discoveries\n- Copyrights: Original works of authorship\n- Trademarks: Brand names, logos, slogans\n- Trade Secrets: Confidential business information\n\n' },
        { insert: '4. OWNERSHIP\n', attributes: { bold: true } },
        { insert: '4.1 Company-Owned IP:\nAll IP created by employees within the scope of employment or using Company resources shall be owned by the Company.\n\n' },
        { insert: '4.2 Prior Inventions:\nEmployees must disclose any prior inventions at the time of hiring.\n\n' },
        { insert: '5. DISCLOSURE REQUIREMENTS\n', attributes: { bold: true } },
        { insert: 'All potentially patentable inventions must be disclosed using the Invention Disclosure Form within {{disclosure_period}} days of conception.\n\n' },
        { insert: '6. PROTECTION PROCEDURES\n', attributes: { bold: true } },
        { insert: '{{protection_procedures}}\n\n' },
        { insert: '7. CONFIDENTIALITY\n', attributes: { bold: true } },
        { insert: 'All IP must be treated as confidential until publicly disclosed through proper channels.\n\n' },
        { insert: '8. THIRD PARTY IP\n', attributes: { bold: true } },
        { insert: 'Employees must not use third party IP without proper authorization or licensing.\n\n' },
        { insert: '9. INVENTOR RECOGNITION\n', attributes: { bold: true } },
        { insert: '{{inventor_recognition}}\n\n' },
        { insert: '10. ENFORCEMENT\n', attributes: { bold: true } },
        { insert: 'Violations of this policy may result in disciplinary action, up to and including termination.\n\n' },
        { insert: '11. QUESTIONS\n', attributes: { bold: true } },
    ...
    placeholders: [
      ...
      { key: 'effective_date', type: 'date', label: 'Effective Date', required: true },
      { key: 'disclosure_period', type: 'number', label: 'Disclosure Period (Days)', required: true },
      { key: 'protection_procedures', type: 'textarea', label: 'Protection Procedures', required: true },
      { key: 'inventor_recognition', type: 'textarea', label: 'Inventor Recognition Program', required: false },
  ...
  },
  {
    ...
    content: {
      ops: [
        ...
        { insert: '- Becomes publicly available without breach\n- Was already known to Receiving Party\n- Is independently developed\n- Is rightfully received from a third party\n\n' },
        { insert: '6. RETURN OF MATERIALS\n', attributes: { bold: true } },
        { insert: 'Upon request or termination, all Trade Secret materials must be returned or destroyed.\n\n' },
        { insert: '7. REMEDIES\n', attributes: { bold: true } },
        { insert: 'Disclosing Party is entitled to injunctive relief and damages for breach.\n\n' },
        { insert: '8. GOVERNING LAW\n', attributes: { bold: true } },
        { insert: 'This Agreement shall be governed by the laws of {{governing_jurisdiction}} and the Defend Trade Secrets Act.\n\n' },
        { insert: 'IN WITNESS WHEREOF:\n\n', attributes: { bold: true } },
    ...
    placeholders: [
      ...
      { key: 'trade_secret_categories', type: 'textarea', label: 'Trade Secret Categories', required: true },
    ...
    signatureFields: [
      { id: 'disclosing_party_signature', label: 'Disclosing Party Signature', required: true, position: { page: 1, x: 100, y: 700 } },
      { id: 'receiving_party_signature', label: 'Receiving Party Signature', required: true, position: { page: 1, x: 100, y: 740 } },
    ],
    settings: { paperSize: 'A4', orientation: 'portrait', margins: { top: 1, right: 1, bottom: 1, left: 1 } },
  },
];
